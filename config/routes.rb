Rails.application.routes.draw do
  ...
  #---------------------------------Product and Product index--------------------------------------------------------
       ...
       get "/products/single_product/:id", to: "products#single_product", as: :single_product

      #  get "/products/new_product", to: "products#product_form",as: :product_form
       ...
       get "/products/edit_product/:id", to: "products#edit_product",as: :edit_product
  ...
  #--------------------------------------User--------------------------------------------------------
     ...
     put "/users/update_user/:id", to:  "users#update_user",as: :update_user
  ...
  #---------------------------------------cart----------------------------------------------------------
     ...
     get "/carts/create_cart/:id", to:  "carts#create_cart"
